...
class controller {
  ...
  function admin(){
	...
	$content = '';
	$content .= form::field('title','title','field function');
	$content .= form::field('synopsis','synopsis','field function');
	
	$array['drop down function']['value'] = "a";
	$array['two']['value'] = "b";
	$content.= form::dropdown($array);
	
	
	
	html::box1('Game',$content,"left","626","267");
